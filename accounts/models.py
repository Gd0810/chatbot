...
class Workspace(models.Model):
    ...
    # Toggle whether the bot widget is visible/active (Master Switch)
    enable_bot_widget = models.BooleanField(default=True, help_text="Master toggle to enable/disable the bot widget")
